class DropBoxController {
    ...
    constructor() {
        ...
        this.inputFileEl = document.querySelector('#files'); // tem no form
    ...
    connectFirebase() {
        ...
        var firebaseConfig = {
            apiKey: "AIzaSyA0AJlpKWIqxpR8pOKeuf3g9sdGPvb8T6c",
            authDomain: "dropbox-clone-15634.firebaseapp.com",
            databaseURL: "https://dropbox-clone-15634.firebaseio.com",
            projectId: "dropbox-clone-15634",
            storageBucket: "dropbox-clone-15634.appspot.com",
            messagingSenderId: "1050399709023",
            appId: "1:1050399709023:web:507a25d325919e21f748ea"
        };
    ...
    initEvents() {
        ...
        this.btnSendFileEl.addEventListener('click', event => {
            //console.log("abrindo janela de upload de arquivo");
        ...
        this.inputFileEl.addEventListener('change', event => {
            ...
            this.uploadTask(event.target.files).then(responses => {
                /**
                 * Ele retorna várias promisses com o promisse.all
                 * por isso temos que ler resposta a resposta
                 */
                responses.forEach(resp => {
                    // colocado em forma de arra por conta do traço
    ...
    uploadTask(files) {
        ...
        [...files].forEach(file => {
            ...
            /**
             * Append do formdata recebe dois parâmetros
             * o primeiro é o nome do campo do formulário que o servidor espera
             * o segundo é o arquivo propriamente dito
             */
    ...
    uploadProgress(event, file) {
        ...
        let timeEspend = Date.now() - this.startUploadTime
        ...
        // Famosa regra de 3
        let timeLeft = ((100 - percent) * timeEspend) / percent
        ...
        ////console.log(timeEspend,timeLeft, percent)

    }

    uploadComplete() {

        this.modalShow(false) // esconde o modal de upload
        this.inputFileEl.value = ''; // zera o inputfile pro onchange funcionar
        this.btnSendFileEl.disabled = false // destrava o btn de envio de arquivo
    ...
    getFileView(file, key) {
        /**
         * Método responsável por mostrar os icones na visualização
        ...
        li.addEventListener('click', e => {
            ...
            if (e.shiftKey) {
                ...
                if (firstLi) {
                    ...
                    let indexStart // vai pegar o index do primeiro clicado
                    let indexEnd // vai pegar o index do primeiro clicado
                    ...
                    /**
                     * para percorrer o  array vamos ordena-lo
                     * o primeiro li tem que ser menar do que o ultimo
                     * precisamos ter essa certeza e podemos fazer por IF ou ordenando um array
                     */
                    ...
                    return true; // retornei para não continuar e add o toggle novamente
                }

            }

            if (!e.ctrlKey) { // se a pessoa clicou no LI e não estava segurando o control
                this.listFilesEl.querySelectorAll('li.selected').forEach(el => { // procuramos todos os LI da lista e percorremos um por um
                    el.classList.remove('selected') /// removendo a classe selected
                })
            }
    ...
    readFiles() {
        //PEGA TODOS OS ARQUIVOS DA CLOUD
